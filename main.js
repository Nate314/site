...
/* harmony import */ var _components_pages_applications_grade_calculator_grade_calculator_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/pages/applications/grade-calculator/grade-calculator.component */ "./src/app/components/pages/applications/grade-calculator/grade-calculator.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _components_application_structure_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/application-structure/not-found/not-found.component */ "./src/app/components/application-structure/not-found/not-found.component.ts");
...
/* harmony import */ var _components_pages_applications_applications_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/pages/applications/applications.component */ "./src/app/components/pages/applications/applications.component.ts");
...
/* harmony import */ var _components_pages_applications_multiplication_table_multiplication_table_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/pages/applications/multiplication-table/multiplication-table.component */ "./src/app/components/pages/applications/multiplication-table/multiplication-table.component.ts");
/* harmony import */ var _components_application_structure_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/application-structure/navigation/navigation.component */ "./src/app/components/application-structure/navigation/navigation.component.ts");
/* harmony import */ var _components_pages_applications_final_grade_calculator_final_grade_calculator_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/pages/applications/final-grade-calculator/final-grade-calculator.component */ "./src/app/components/pages/applications/final-grade-calculator/final-grade-calculator.component.ts");
/* harmony import */ var _components_pages_applications_betting_calculator_betting_calculator_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/pages/applications/betting-calculator/betting-calculator.component */ "./src/app/components/pages/applications/betting-calculator/betting-calculator.component.ts");
/* harmony import */ var _components_pages_applications_color_flux_color_flux_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/pages/applications/color-flux/color-flux.component */ "./src/app/components/pages/applications/color-flux/color-flux.component.ts");
/* harmony import */ var _components_pages_applications_flappy_finch_flappy_finch_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/pages/applications/flappy-finch/flappy-finch.component */ "./src/app/components/pages/applications/flappy-finch/flappy-finch.component.ts");
/* harmony import */ var _components_pages_applications_floaty_stars_floaty_stars_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/pages/applications/floaty-stars/floaty-stars.component */ "./src/app/components/pages/applications/floaty-stars/floaty-stars.component.ts");
/* harmony import */ var _components_pages_applications_group_creator_group_creator_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/pages/applications/group-creator/group-creator.component */ "./src/app/components/pages/applications/group-creator/group-creator.component.ts");
/* harmony import */ var _components_pages_applications_html_sandbox_html_sandbox_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/pages/applications/html-sandbox/html-sandbox.component */ "./src/app/components/pages/applications/html-sandbox/html-sandbox.component.ts");
/* harmony import */ var _components_pages_applications_say2_say2_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/pages/applications/say2/say2.component */ "./src/app/components/pages/applications/say2/say2.component.ts");
...
var routes = [
    ...
    { path: 'applications', component: _components_pages_applications_applications_component__WEBPACK_IMPORTED_MODULE_5__["ApplicationsComponent"] },
    { path: 'videos', component: _components_pages_videos_videos_component__WEBPACK_IMPORTED_MODULE_6__["VideosComponent"] },
    { path: 'applications/java', redirectTo: '/applications?subpage=java', pathMatch: 'full' },
    { path: 'applications/web', redirectTo: '/applications?subpage=web', pathMatch: 'full' },
    { path: 'applications/android', redirectTo: '/applications?subpage=android', pathMatch: 'full' },
    { path: 'applications/web/:application', component: _components_application_structure_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_8__["NavigationComponent"] },
    { path: 'webapplications/bettingcalculator', component: _components_pages_applications_betting_calculator_betting_calculator_component__WEBPACK_IMPORTED_MODULE_10__["BettingCalculatorComponent"] },
    { path: 'webapplications/colorflux', component: _components_pages_applications_color_flux_color_flux_component__WEBPACK_IMPORTED_MODULE_11__["ColorFluxComponent"] },
    { path: 'webapplications/finalgradecalculator', component: _components_pages_applications_final_grade_calculator_final_grade_calculator_component__WEBPACK_IMPORTED_MODULE_9__["FinalGradeCalculatorComponent"] },
    { path: 'webapplications/flappyfinch', component: _components_pages_applications_flappy_finch_flappy_finch_component__WEBPACK_IMPORTED_MODULE_12__["FlappyFinchComponent"] },
    { path: 'webapplications/floatystars', component: _components_pages_applications_floaty_stars_floaty_stars_component__WEBPACK_IMPORTED_MODULE_13__["FloatyStarsComponent"] },
    { path: 'webapplications/gradecalculator', component: _components_pages_applications_grade_calculator_grade_calculator_component__WEBPACK_IMPORTED_MODULE_0__["GradeCalculatorComponent"] },
    { path: 'webapplications/groupcreator', component: _components_pages_applications_group_creator_group_creator_component__WEBPACK_IMPORTED_MODULE_14__["GroupCreatorComponent"] },
    { path: 'webapplications/htmlsandbox', component: _components_pages_applications_html_sandbox_html_sandbox_component__WEBPACK_IMPORTED_MODULE_15__["HtmlSandboxComponent"] },
    { path: 'webapplications/multiplicationtable', component: _components_pages_applications_multiplication_table_multiplication_table_component__WEBPACK_IMPORTED_MODULE_7__["MultiplicationTableComponent"] },
    { path: 'webapplications/say2', component: _components_pages_applications_say2_say2_component__WEBPACK_IMPORTED_MODULE_16__["Say2Component"] },
    { path: '**', component: _components_application_structure_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__["NotFoundComponent"] }
];
...
/* harmony import */ var _components_application_structure_app_component_app_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/application-structure/app-component/app.component */ "./src/app/components/application-structure/app-component/app.component.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _components_application_structure_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/application-structure/navbar/navbar.component */ "./src/app/components/application-structure/navbar/navbar.component.ts");
/* harmony import */ var _components_application_structure_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/application-structure/not-found/not-found.component */ "./src/app/components/application-structure/not-found/not-found.component.ts");
/* harmony import */ var _components_application_structure_footer_footer_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/application-structure/footer/footer.component */ "./src/app/components/application-structure/footer/footer.component.ts");
...
/* harmony import */ var _components_pages_applications_applications_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/pages/applications/applications.component */ "./src/app/components/pages/applications/applications.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _components_pages_videos_videos_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/pages/videos/videos.component */ "./src/app/components/pages/videos/videos.component.ts");
/* harmony import */ var _components_pages_applications_multiplication_table_multiplication_table_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/pages/applications/multiplication-table/multiplication-table.component */ "./src/app/components/pages/applications/multiplication-table/multiplication-table.component.ts");
/* harmony import */ var _components_application_structure_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/application-structure/navigation/navigation.component */ "./src/app/components/application-structure/navigation/navigation.component.ts");
/* harmony import */ var _components_pages_applications_final_grade_calculator_final_grade_calculator_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/pages/applications/final-grade-calculator/final-grade-calculator.component */ "./src/app/components/pages/applications/final-grade-calculator/final-grade-calculator.component.ts");
/* harmony import */ var _components_pages_applications_betting_calculator_betting_calculator_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/pages/applications/betting-calculator/betting-calculator.component */ "./src/app/components/pages/applications/betting-calculator/betting-calculator.component.ts");
/* harmony import */ var _components_pages_applications_say2_say2_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/pages/applications/say2/say2.component */ "./src/app/components/pages/applications/say2/say2.component.ts");
/* harmony import */ var _components_pages_applications_group_creator_group_creator_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/pages/applications/group-creator/group-creator.component */ "./src/app/components/pages/applications/group-creator/group-creator.component.ts");
/* harmony import */ var _components_pages_applications_html_sandbox_html_sandbox_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/pages/applications/html-sandbox/html-sandbox.component */ "./src/app/components/pages/applications/html-sandbox/html-sandbox.component.ts");
/* harmony import */ var _components_pages_applications_color_flux_color_flux_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/pages/applications/color-flux/color-flux.component */ "./src/app/components/pages/applications/color-flux/color-flux.component.ts");
/* harmony import */ var _components_pages_applications_flappy_finch_flappy_finch_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/pages/applications/flappy-finch/flappy-finch.component */ "./src/app/components/pages/applications/flappy-finch/flappy-finch.component.ts");
/* harmony import */ var _components_pages_applications_floaty_stars_floaty_stars_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/pages/applications/floaty-stars/floaty-stars.component */ "./src/app/components/pages/applications/floaty-stars/floaty-stars.component.ts");
/* harmony import */ var _components_pages_applications_grade_calculator_grade_calculator_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/pages/applications/grade-calculator/grade-calculator.component */ "./src/app/components/pages/applications/grade-calculator/grade-calculator.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _components_application_structure_app_component_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
                _components_application_structure_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__["NavbarComponent"],
                _components_application_structure_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_6__["NotFoundComponent"],
                _components_pages_home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"],
                _components_application_structure_footer_footer_component__WEBPACK_IMPORTED_MODULE_7__["FooterComponent"],
                _components_pages_applications_applications_component__WEBPACK_IMPORTED_MODULE_9__["ApplicationsComponent"],
                _components_pages_videos_videos_component__WEBPACK_IMPORTED_MODULE_11__["VideosComponent"],
                _components_pages_applications_multiplication_table_multiplication_table_component__WEBPACK_IMPORTED_MODULE_12__["MultiplicationTableComponent"],
                _components_application_structure_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_13__["NavigationComponent"],
                _components_pages_applications_final_grade_calculator_final_grade_calculator_component__WEBPACK_IMPORTED_MODULE_14__["FinalGradeCalculatorComponent"],
                _components_pages_applications_betting_calculator_betting_calculator_component__WEBPACK_IMPORTED_MODULE_15__["BettingCalculatorComponent"],
                _components_pages_applications_say2_say2_component__WEBPACK_IMPORTED_MODULE_16__["Say2Component"],
                _components_pages_applications_group_creator_group_creator_component__WEBPACK_IMPORTED_MODULE_17__["GroupCreatorComponent"],
                _components_pages_applications_html_sandbox_html_sandbox_component__WEBPACK_IMPORTED_MODULE_18__["HtmlSandboxComponent"],
                _components_pages_applications_color_flux_color_flux_component__WEBPACK_IMPORTED_MODULE_19__["ColorFluxComponent"],
                _components_pages_applications_flappy_finch_flappy_finch_component__WEBPACK_IMPORTED_MODULE_20__["FlappyFinchComponent"],
                _components_pages_applications_floaty_stars_floaty_stars_component__WEBPACK_IMPORTED_MODULE_21__["FloatyStarsComponent"],
                _components_pages_applications_grade_calculator_grade_calculator_component__WEBPACK_IMPORTED_MODULE_22__["GradeCalculatorComponent"]
            ],
            imports: [
            ...
            bootstrap: [_components_application_structure_app_component_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.router.events.subscribe(function (event) {
            ...
            if (event instanceof _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationStart"]) {
                //if (this.history.length == 0 || this.history.length == 1) {
                //  //for(var i = 0; i < 10; i++) this.location.back();
                //}
                //else {
                if (event.navigationTrigger == "popstate") {
                    console.log("History", _this.history);
                    _this.sent = true;
                    if (_this.history.length == ["/"].length) {
                        _this.leavePage = true;
                    }
                    else {
                        console.log("SENDING TO", _this.history.length, _this.history[_this.history.length - 2]);
                        _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].navigate(_this.router, _this.location, _this.history[_this.history.length - 2]);
                        var tempHistory = [];
                        for (var i = 0; i < _this.history.length - 1; i++) {
                            tempHistory.push(_this.history[i]);
                        }
                        _this.history = tempHistory;
                        console.log(_this.history);
                    }
                }
                //}
            }
            else if (event instanceof _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]) {
                if (!_this.sent) {
                    if (!event.url.toLocaleLowerCase().includes("not-found")) {
                        if (event.url !== _this.history[_this.history.length - 1])
                            if (_this.history[_this.history.length - 1] === "/" && event.url === "/home") { }
                            else {
                                _this.history.push(event.url);
                            }
                    }
                }
                else {
...
/***/ "./src/app/components/application-structure/navigation/navigation.component.css":
/*!**************************************************************************************!*\
  !*** ./src/app/components/application-structure/navigation/navigation.component.css ***!
  \**************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/application-structure/navigation/navigation.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/components/application-structure/navigation/navigation.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/application-structure/navigation/navigation.component.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/components/application-structure/navigation/navigation.component.ts ***!
  \*************************************************************************************/
...
var NavigationComponent = /** @class */ (function () {
    function NavigationComponent(router, location) {
        this.router = router;
        this.location = location;
    }
    NavigationComponent.prototype.ngOnInit = function () {
        // /applications/web/multiplicationtable
        // /applications?subpage=web&appName=multiplicationtable
        var url = this.router.url.split("/");
        var _subpage = url[2];
        var _appName = url[3];
        _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].navigateTo(this.router, this.location, ["/applications"], { queryParams: { subpage: _subpage, appName: _appName } });
        /*
        var url = this.router.url;
        if(url.split("?").length > 1) {
          ...
          for(var i = 0; i < params.length; i++) {
            ...
            switch(param[0]) {
              case "subpage":
                if(param[1] == "web") subpage = "webapplications";
                break;
              case "appName": appName = param[1];
                break;
            }
          }
          console.log("Navigating to v");
          console.log(`${subpage}/${appName}`);
          console.log("Navigating to ^");
          Helper.navigate(this.router, this.location, `${subpage}/${appName}`);
        }
        */
    };
    NavigationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./navigation.component.html */ "./src/app/components/application-structure/navigation/navigation.component.html"),
            styles: [__webpack_require__(/*! ./navigation.component.css */ "./src/app/components/application-structure/navigation/navigation.component.css")]
        }),
        __metadata("design:paramtypes", [_node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _node_modules_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"]])
    ], NavigationComponent);
...
module.exports = "<div *ngIf=\"!webAppURL && apps.length == 0\" class=\"container\">\n  <div *ngFor=\"let page of subpages\" class=\"border border-top-0 border-left-0 border-right-0\">\n    <h1>{{ page.name }}</h1>\n    <div *ngIf=\"page.name.toUpperCase().includes('JAVA')\">\n        You can downlad any of these java applications\n        by clicking on the name of the application below,\n        or you can view a list of all of the applications and descriptions\n      <a (click)=\"openSubPage('java')\" class=\"hyperlink w3-hover-text-purple\">here</a>.\n    </div>\n    <div *ngIf=\"page.name.toUpperCase().includes('WEB')\">\n      You can use any of these web applications\n      by clicking on the name of the application below,\n      or you can view a list of all of the applications and descriptions\n    <a (click)=\"openSubPage('web')\" class=\"hyperlink w3-hover-text-purple\">here</a>.\n    </div>\n    <div *ngIf=\"page.name.toUpperCase().includes('ANDROID')\">\n        You can downlad any of these java applications\n        by clicking on the name of the application below,\n        or you can view a list of all of the applications and descriptions\n        <a (click)=\"openSubPage('android')\" class=\"hyperlink w3-hover-text-purple\">here</a>.\n    </div>\n    <span *ngFor=\"let app of page.apps; let i = index\">\n      <a *ngIf=\"page.name.toUpperCase().includes('JAVA')\" (click)=\"openJavaApp(app)\"\n      class=\"hyperlink w3-hover-text-purple\">{{ app.name }}</a>\n      <a *ngIf=\"page.name.toUpperCase().includes('WEB')\" (click)=\"openWebApp(app)\"\n      class=\"hyperlink w3-hover-text-purple\">{{ app.name }}</a>\n      <a *ngIf=\"page.name.toUpperCase().includes('ANDROID')\" (click)=\"openAndroidApp(app)\"\n      class=\"hyperlink w3-hover-text-purple\">{{ app.name }}</a>\n      <span *ngIf=\"i != page.apps.length - 1 && i != page.apps.length - 2\">, </span>\n      <span *ngIf=\"i == page.apps.length - 2\">, and </span>\n      <span *ngIf=\"i == page.apps.length - 1\">. </span>\n    </span>\n  </div>\n</div>\n<div *ngIf=\"!webAppOpen && pageName != null\">\n  <h1 class=\"border border-top-0 border-left-0 border-right-0\">\n    {{ pageName }}\n  </h1>\n  <div *ngFor=\"let app of apps\" class=\"border border-top-0 border-left-0 border-right-0\">\n    <h3>\n      {{ app.name }}\n    </h3>\n    <div>\n      <span [innerHtml]=\"app.description\"></span>\n      <br />\n      <div *ngIf=\"pageName.toUpperCase().includes('JAVA')\">\n        <b>Download</b>&nbsp;<a class=\"hyperlink w3-hover-text-purple\" (click)=\"openJavaApp(app)\">\n        {{ app.name }}</a>\n      </div>\n      <div *ngIf=\"pageName.toUpperCase().includes('WEB')\">\n        <b>Go to</b>&nbsp;<a class=\"hyperlink w3-hover-text-purple\" (click)=\"openWebApp(app)\">\n        {{ app.name }}</a>\n      </div>\n      <div *ngIf=\"pageName.toUpperCase().includes('ANDROID')\">\n        <b>Download</b>&nbsp;<a class=\"hyperlink w3-hover-text-purple\" (click)=\"openAndroidApp(app)\">\n        {{ app.name }}</a>\n      </div>\n    </div>\n  </div>\n</div>\n<div id=\"appContent\"></div>\n<div id=\"appDescription\"></div>\n"
...
var ApplicationsComponent = /** @class */ (function () {
    function ApplicationsComponent(router, location /*, private http: HttpClient*/) {
        this.router = router;
        this.location = location; /*, private http: HttpClient*/
        this.webAppOpen = false;
        this.webAppURL = "";
        this.webAppName = "";
        this.webAppDescription = "";
        this.subpage = "";
        this.apps = [];
        this.subpages = [];
        this.JavaApps = [];
    ...
    ApplicationsComponent.prototype.closeWebApp = function () {
        this.webAppOpen = false;
    };
    ApplicationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].initializePage(this, this.router.url, _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["PageNames"].APPLICATIONS);
        // retrieve info from db
        var db = _modules_DB__WEBPACK_IMPORTED_MODULE_4__["DB"].getDB();
        this.subpages = [];
        var subpages = db.nate314.home.pages[0]["subpages"];
        for (var i = 0; i < subpages.length; i++) {
            this.subpages.push({ name: subpages[i].name, apps: subpages[i]["apps"] });
        }
        this.webAppOpen = false;
        this.webAppURL = this.router["currentUrlTree"].queryParams.appURL;
        this.webAppName = this.router["currentUrlTree"].queryParams.appName;
        this.webAppDescription = this.router["currentUrlTree"].queryParams.appDescription;
        this.subpage = this.router["currentUrlTree"].queryParams.subpage;
        if (this.subpage != undefined) {
            this.subpages.forEach(function (page) {
                if (page.name.toUpperCase().includes(_this.subpage.toUpperCase())) {
                    _this.pageName = page.name;
                    _this.apps = page.apps;
                }
            });
        }
        // if a web app is being passed through the url, then open that web app
        if (!_modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].equalsNull(this.webAppName)) {
            //this.openWebAppURL(this.webAppName, this.webAppURL, this.webAppDescription);
            this.openWebAppURL(this.webAppName);
        }
    };
    ApplicationsComponent.prototype.openWebAppURL = function (_name) {
        this.openWebApp({ name: _name });
    };
    ApplicationsComponent.prototype.openWebApp = function (app) {
        // find app by name
        for (var i = 0; i < this.apps.length; i++)
            if (this.apps[i].name.toUpperCase() == app.name.toUpperCase())
                app = this.apps[i];
        // set url
        ...
        // send to app
        if (_modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].equalsNull(this.webAppName))
            _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].navigateTo(this.router, this.location, ["/applications"], { queryParams: { subpage: "web", appName: app.name } });
        // open app
        this.webAppURL = iFrameURL;
    ...
    ApplicationsComponent.prototype.openSubPage = function (_subpage) {
        _modules_Helper__WEBPACK_IMPORTED_MODULE_3__["Helper"].navigateTo(this.router, this.location, ["/applications"], { queryParams: { subpage: _subpage } });
    };
    ApplicationsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] /*, private http: HttpClient*/])
    ...
    BettingCalculatorComponent.prototype.playerWon = function (winnerID) {
        ...
        for (var i = 0; i < this.humans; i++) {
            if (this.grid[i][winnerID] != 0)
                winnings.push(parseInt(((this.grid[i][winnerID] / winningPot) * totalLoot) + ""));
            else
                winnings.push(0);
        }
...
var GradeCalculatorComponent = /** @class */ (function () {
    ...
    GradeCalculatorComponent.prototype.finalGradeRequired = function (currentGrade, finalPercentage, goal) {
        return Math.round(10000 * ((goal - (currentGrade * (1 - finalPercentage))) / finalPercentage));
    };
    GradeCalculatorComponent.prototype.finalGrade = function (currentGrade, finalPercentage, requiredFinalGrade) {
        return Math.round(10000 * ((currentGrade * (1 - finalPercentage)) + (requiredFinalGrade * finalPercentage)));
    };
...
var GroupCreatorComponent = /** @class */ (function () {
    ...
    GroupCreatorComponent.prototype.generateList = function () {
        ...
        var maxPeople;
        var groupRange;
        names = document.getElementById("list").value.split(",");
        document.getElementById("numberOfNames").innerHTML = names.length + " Names";
        minPeople = document.getElementById("minPeople").value;
        maxPeople = document.getElementById("maxPeople").value;
        groupRange = maxPeople - minPeople;
        console.log("-----" + (Math.floor(Math.random() * groupRange) + minPeople) + "-----");
        console.log(minPeople + " - " + maxPeople);
        console.log("-- " + groupRange);
        // var groupSizes = [];
        var allocatedPeople = 0;
        var list = "<br>";
        var listOfNumbers = "";
        var numberToAdd = 0;
        var index = 0;
        var groupSizes = new Array(1000); //new Array(groupSizes1.length);
        while(true)
        {
            numberToAdd = (Math.floor(Math.random() * groupRange) + minPeople);
            console.log("Math.floor(Math.random() * " + groupRange + ") + " + minPeople);
            console.log("number - " + numberToAdd);
            if(allocatedPeople + numberToAdd >= names.length)
            {
                numberToAdd = names.length - allocatedPeople;
                // groupSizes.push(numberToAdd);
                listOfNumbers += numberToAdd + "";
                allocatedPeople += numberToAdd;
                break;
            }
            else
            {
            ...
            groupSizes[index] = numberToAdd;
            index++;
        }
        // console.log(listOfNumbers);
        // var groupSizes1 = listOfNumbers.split(",");
        // for(var i = 0; i < groupSizes1.length; i++)
        // {
        //     groupSizes[i] = myParseInt(groupSizes1[i]);
        // }
        ...
        // document.getElementById("output").innerHTML = groupSizes;
...
var VideosComponent = /** @class */ (function () {
    ...
    VideosComponent.prototype.ngOnInit = function () {
        ...
        var db = _modules_DB__WEBPACK_IMPORTED_MODULE_4__["DB"].getDB();
        var dbVideos = db.nate314.home.pages[1].subpages[0]["videos"];
        this.videos = [];
...
var db = {
    nate314: {
        home: {
            ...
            otherwebsites: "Check out my friend's websites. They have also have lots of cool software that you can download.<ul><li>Hanavan's <a href=\"http://thekuhnbros.com/hanavan/\">website</a></li><li>Cody's <a href=\"https://codymoose.github.io\">website</a></li><li>Alex's <a href=\"http://alexwebber.org/\">website</a></li></ul>>",
            pages: [{
                    title: "Applications",
                    name: "Applications",
                    subpages: [{
                            name: "JavaApplications",
                            description: "You can download any of these java applications or read about what they are by clicking on the name of each application, or you can view a list of all of the applications and descriptions <a href=\"javaApplications/index.html\">here</a>.",
                            apps: [
                                /*
                                {
                                    name: "CircleSpawner",
                                    file: "CircleSpawner0.1.jar",
                                    description: "This is my Circle Spawner prgram written in Java. This is an application that simply spawns a circle with the desired diameter in pixels. Be careful though! The program creates the circle using many many boarderless windows, which could be hard to close without a restart if you type in too large of a number."
                                },
                                */
                                {
                                    name: "Clock",
                                    file: "Clock.jar",
                                    description: "This is a Clock prgram written in Java. This application is pretty self explanitory. When launched, an analog clock will be displayed with the current time. If you prefer digital, just click on the clock to toggle between analog and digital."
                                },
                                {
                                    name: "DinoGame1920x1080",
                                    file: "DinoGame1920x1080.jar",
                                    description: "This is a game playing bot written in Java. This program jumps over most cacti in the Dinosaur Game that can be played in Google Chrome when you don't have an internet connection. Sadly, it only currently works on a screen resolution of 1920x1080 when Chrome is maximized in windows. It doesn't yet duck under the pterodactyls yet, so you will have to take care of that part of the game yourself."
                                },
                                {
                                    name: "FlappyBird",
                                    file: "FlappyBird1.1.zip",
                                    description: "This is my verion of Flappy Bird written in Java. Controls are listed below: <br>space: flap<br /><code>p: play/pause<br>d: toggle developer mode<br>r: restart <br>left/right: slow down/speed up game</code>"
                                },
                                {
                                    name: "Minesweeper",
                                    file: "Minesweeper1.2.jar",
                                    description: "This is my verion of Microsoft's Minesweeper written in Java. You can flag a square by right clicking, or attack by left clicking."
                                },
                                {
                                    name: "NathaNOS",
                                    file: "NathaNOS1.1.zip",
                                    description: "This is my \"OS\" written in Java. When you open it, the easiest way to close it is to use the Shut Down button found by clicking on the menu in the bottom left hand corner. This \"OS\" was written to run Java applications inside of it. The only application that I have included with this version of NathaNOS is my clock application. To run a java program inside of it, drag and drop the jar file into the NathaNOS1.1/assets and you should be ready to go!</p> <p>Note: if you want to add one of your own java programs to NathaNOS, then you will have to make the main class extend a JFrame, and you will have to make the constructor of your main class have one parameter that is a Boolean for visibility. You can see an example below:<pre><code>package clock;\n\nimport javax.swing.JFrame;\n\npublic class Main extends JFrame\n{\n\tpublic Main(Boolean visibility)\t{\n\t\tthis.setVisible(visibility.booleanValue());\n\t}\n}\n</code></pre>"
                                },
                                {
                                    name: "RubiksCube2D",
                                    file: "RubiksCube2D_3.jar",
                                    description: "This is a 2D Rubik's Cube written in Java. To rotate, click on a square and then use wasd to rotate in the correlated direction."
                                },
                                {
                                    name: "ScreenSaver",
                                ...
                                },
                                {
                                    ...
                                    description: "This is a background program written in Java. Check out each of the cool modes. My personal favorite is Mode 3."
                                },
                                /*
                                {
                                    name: "StockChecker",
                                    file: "StockChecker1.2.2.zip",
                                    description: "This is my Stock Checker written in Java. You can add stocks by pressing the \"Add Stock\" button, or subtract rows by pressing the \"Delete Stock\" button. When pressing refresh, the application will check the price of all of the stocks and update the prices on the right. If you want the program to come to start up with different stock by default, edit the myStocks.txt to look something like this: <code>crm,lmt,tsn,nflx,swk</code>"
                                },
                                {
                                    name: "SynthesizerKeyboard",
                                    file: "SynthesizerKeyboard.jar",
                                    description: "This is a Synthesizer/Keyboard written in Java. Other than programming, I also enjoy playing the piano. You can play this keyboard by using the bottom row of your keyboard (zxcvbnm,) for the white keys, and (sdghj) for the black keys. The left and right arrow keys adjust the octave that you are playing, and the up and down arrow keys change the instrument. At this point, the only way to close the keyboard if you accidentally click on a key is by killing the process in TaskManager. Sorry for the bug!"
                                },
                                */
                                {
                                    name: "UltimateTicTacToe",
                                    file: "UltimateTicTacToe1.1.jar",
                                    description: "This is an UltimateTicTacToe game written in Java. If you don't know how to play, you can check out the rules <a href=\"https://www.youtube.com/watch?v=37PC0bGMiTI\">here</a>"
                                },
                            ]
                        },
                        {
                            name: "WebApplications",
                            description: "You can download any of these web applications or read about what they are by clicking on the name of each application, or you can view a list of all of the applications and descriptions <a href=\"webApplications/index.html\">here</a>.",
                            apps: [{
                                    name: "BettingCalculator",
                                    file: "webapplications/bettingcalculator",
                                    description: "Betting Calculator can be used if you want to place bets on things and don't want to have to worry about the math. You can set up the number of things you are btting on and the number of humans that are placing bets, and then the winnings will be split proportionally between the palyers that placed bets on the thing that actually won."
                                },
                                {
                                    name: "ColorFlux",
                                    file: "https://nate314.github.io/nathangawith/applications/webApplications/colorFlux.html",
                                    description: "Color Flux is an application that you could possibly use as a live background written in javascript. It just pulses between different colors continuously."
                                },
                                {
                                    name: "FinalGradeCalculator",
                                    file: "webapplications/finalgradecalculator",
                                    description: "Final Grade Caclculator is a useful tool for when you are in a crunch and want to prioritize study time. Enter your current grade in the class, the percentage of your grade the final is worth, and the percentage you want to finish the class with. Once you submit, this application will tell you the percentage you need in order to achieve your goal."
                                },
                                {
                                    name: "GradeCalculator",
                                    file: "webapplications/gradecalculator",
                                    description: "Currently, this calculator is hard coded to work for Jacob Pursley's Physics 240 class, but I plan on de-hardcoding it in the future."
                                },
                                {
                                    name: "FlappyFinch",
                                    file: "https://nate314.github.io/nathangawith/applications/webApplications/flappyFinch.html",
                                    description: "Flappy Finch is a spin off of Flappy Bird created using javascipt. There is currently no collision code in place, so there is no way for the game to end. I wrote this to learn how to do an animation using a javscript canvas."
                                },
                                {
                                    name: "FloatyStars",
                                    file: "https://nate314.github.io/nathangawith/applications/webApplications/floatyStars.html",
                                    description: "Floaty Stars is a simple application that I built to learn how to do 2D animations in javascript."
                                },
                                {
                                    name: "GroupCreator",
                                    file: "webapplications/groupcreator",
                                    description: "Group Creator is a great application to use if you want to create random groups of people and want to do it in an efficient way using pure computer randomness."
                                },
                                {
                                    name: "HTMLSandbox",
                                    file: "webapplications/htmlsandbox",
                                    description: "HTML Sandbox is a great application to use if you want to learn how to code in HTML but don't have a way of editing code on your computer or just want to try something out real quick in your browser."
                                },
                                {
                                    name: "MultiplicationTable",
                                    file: "webapplications/multiplicationtable",
                                    description: "Multiplication Table is pretty much self explanitory. Enter a number between 0 and 120 and a multiplication table will be generated with that size."
                                },
                                {
                                    name: "Say2",
                                    file: "webapplications/say2",
                                    description: "Say2 is a simple program that takes a number as input and outputs the english text for that number. For example: if you type in \"123\", the program will output \"one hundred twenty three\". Say2 was originally a challenge that many of the programmers on my robotics team completed as part of java training. Say2 is the first web application that I have written in JavaScript, which even though JavaScript sounds like Java, the two languages are almost just as similar to each other as a car is to carpet."
                                }
                            ]
                        },
                        {
                            name: "AndroidApplications",
                            description: "You can download any of these android applications or read about what they are by clicking on the name of each application, or you can view a list of all of the applications and descriptions <a href=\"androidApplications/index.html\">here</a>.",
                            "apps": [{
                                    name: "LiveWallpaper",
                                    file: "LiveWallpaper.apk",
                                    description: "Live Wallpaper is my first fully functional android application that I have written. This live wallpaper changes color based on what direction your phone is facing using all three angles available (pitch, roll, and azmuth) from the standard accelerometer found in most phones. You can use this live wallpaper by downloading and installing the apk file and then selecting \"Live Wallpaper\" as your live wallpaper for your phone or tablet."
                                }]
                        }
                    ]
                },
                            ...
                            videos: [
                                {
                                    ...
                                    description: "This is my favorite timelapse I have made. It shows a 3x3x3 puzzle cube \"solving itself\". I accomplished this by taking a picture of the cube every quarter turn."
                                },
                                {
                                    title: "Timelapse - Rubik's",
                                    link: "https://www.youtube.com/embed/EtycVB_mPnQ",
                                    description: "This is the first timelapse video I ever made. This is also a video of a cube solving itself, but this one doesn't look as nice as the one above because I only took one picture for each turn. I also thought it would be a good idea to show the clock so that you can see how long it took."
                                },
                                {
                                    title: "Mosaic - MVTV",
                                    link: "https://www.youtube.com/embed/hD42xobUROM",
                                    description: "I was interviewed about my puzzle cube collection and hobby while in high school, so I made this mosaic for the high school broadcasting class to use as a nice outro for the interview."
                                },
                                {
                                    title: "Mosaic - US Flag",
                                    link: "https://www.youtube.com/embed/V4cVGX8jyfI",
                                    description: "This was probably the easiest mosaic I made as stripes are easy for anyone to make with cubes whether or not you know how to solve a puzzle cube."
                                },
                                {
                                    title: "Dream Home - Ground Floor",
                                    link: "https://www.youtube.com/embed/9rEE0PjNMA4",
                                    description: "In my \"Architectural Design\" course in high school, we designed our dream home in autocad and then made a 3D rendering. This is a video showing walking around the ground floor."
                                },
                                {
                                    title: "Dream Home - Basement",
                                    link: "https://www.youtube.com/embed/cDsXrYSNA8c",
                                    description: "In my \"Architectural Design\" course in high school, we designed our dream home in autocad and then made a 3D rendering. This is a video showing walking around the basement."
                                },
                                {
                                    title: "Typling Bot",
...
var Helper = /** @class */ (function () {
    ...
    Helper.equalsNull = function (thing) {
    ...
    Helper.navigate = function (router, location, url) {
        if (url.includes("?")) {
            ...
            for (var i = 0; i < query.length; i++) {
                queryParams += "'" + query[i].split("=")[0] + "'";
                queryParams += ":";
                queryParams += "'" + query[i].split("=")[1] + "'";
                if (i != query.length - 1)
                    queryParams += ",";
            }
            queryParams += "}";
            Helper.navigateTo(router, location, [url.split("?")[0]], JSON.parse(queryParams));
        }
        else {
            if (url === "/") {
                url = "/home";
            }
            /*if(url.includes("application") && Constants.currentPageURL.includes("application")) {*/
            setTimeout(function () {
                router.navigate(["/not-found"]);
            }, 0);
            /*}*/
